...
project_keypoints = {
    "front": [(shift_w + 80, shift_h),
              (shift_w + 80, shift_h + 80),
              (total_w - shift_w - 80, shift_h + 80),
              (total_w - shift_w - 80, shift_h)],
    ...
    "left":  [(shift_h + 80, shift_w),
              (shift_h + 80, shift_w + 80),
              (total_h - shift_h - 80, shift_w + 80),
